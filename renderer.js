...
function syncAmpmNow(){const t=use12h()?ampmLabel(new Date().getHours()):"";lastAmpmText=t;applyAmpm(t);}
...
function gd(){const n=new Date();const h24=n.getHours();const hh=String(use12h()?(h24%12||12):h24).padStart(2,"0");const mm=String(n.getMinutes()).padStart(2,"0");const ss=String(n.getSeconds()).padStart(2,"0");return cfg.showSeconds!==false?{d:(hh+mm+ss).split(""),cc:2}:{d:(hh+mm).split(""),cc:1};}
